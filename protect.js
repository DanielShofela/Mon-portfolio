...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        contactForm.setAttribute('action', 'https://formspree.io/f/mqaawkvr');
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            .then(data => {
                if (data.ok) {
                    document.getElementById('form-status').textContent = 'Message envoyé avec succès !';
                    contactForm.reset();
                } else {
                    document.getElementById('form-status').textContent = 'Une erreur est survenue. Veuillez réessayer.';
                }
            })
            .catch(error => {
                document.getElementById('form-status').textContent = 'Une erreur est survenue. Veuillez réessayer.';
